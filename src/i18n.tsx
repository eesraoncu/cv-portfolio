...
const dictionary: Dictionary = {
  ...
  'skills.certificatesSection': { tr: 'Sertifikalar', en: 'Certificates' },
  ...
  'about.p1': { tr: 'Burdur Mehmet Akif Ersoy Üniversitesi Yazılım Mühendisliği bölümünde öğrenciyim. Backend teknolojileri ve veritabanı yönetimi konularında geliştiriciyim.', en: 'I am a Software Engineering student at Burdur Mehmet Akif Ersoy University. I focus on backend technologies and database management.' },
  'about.p2': { tr: 'Java, Spring Boot, PostgreSQL ve modern backend teknolojileri ile çalışmaktan keyif alıyorum. Güvenli ve ölçeklenebilir sistemler geliştirmeye odaklanıyorum.', en: 'I enjoy working with Java, Spring Boot, PostgreSQL and modern backend technologies. I focus on building secure and scalable systems.' },
  'about.p3': { tr: 'Bilgi Teknolojileri ve İletişim Kurumunda yaz stajı deneyimim bulunmaktadır. Ekip çalışmasına yatkın, problem çözme becerileri güçlü ve sürekli öğrenmeye açık bir öğrenciyim.', en: 'I completed a summer internship at the Information and Communication Technologies Authority. I am a team player with strong problem-solving skills and a passion for continuous learning.' },
  ...
  'hero.tagline': { tr: 'Backend teknolojileri konusunda öğrenmeye devam eden, güvenli ve ölçeklenebilir sistemler geliştirmeye odaklanan bir yazılım geliştiricisi öğrencisi.', en: 'A software developer student focused on learning backend technologies and building secure, scalable systems.' },
